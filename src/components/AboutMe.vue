    ...
    <div class="about-me grid lg:grid-cols-2 xl:grid-cols-3 gap-8 p-16 m-auto">
      <div class="lg:col-span-1 xl:col-span-2 text-justify">
        ...
        <div class="flex justify-evenly mt-12">
            ...
            <button class="portfolio-btn flex justify-center items-center lg:mx-2 py-2 px-4 bg-sky-500 hover:bg-sky-700 rounded text-white text-center font-semibold w-44" href="#portfolio-container"><i class="fa-solid fa-circle-arrow-right"></i><span class="ml-2">View Portfolio</span></button>
